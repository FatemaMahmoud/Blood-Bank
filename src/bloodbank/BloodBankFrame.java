...
public class BloodBankFrame extends javax.swing.JFrame {
   ...
   private Graph g;
    ...
    private void scndInitComps(){
        ...
        LastDonationDay1.setSelectedIndex(1);
        LastDonationMonth1.setSelectedIndex(1);
        LastDonationYear1.setSelectedIndex(1);
    }
    ...
    private void initComponents() {
        ...
        BloodType1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "AB+", "AB-", "A+", "A-", "B+", "B-", "O+", "O-" }));
        BloodType1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BloodType1ActionPerformed(evt);
            }
        });
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (newDonor) {
            ...
            if (mail.equals("")) {
                JOptionPane.showMessageDialog(this, "Please enter donor's E-mail");
            } else if (cont.isValid(lastTime, current)) {

                cont.addDonor(this.jRadioButton6.isSelected(), this.name1.getText(), this.Age1.getText(), mail,
    ...
    private void BloodType1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BloodType1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BloodType1ActionPerformed
